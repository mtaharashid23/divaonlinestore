...
function sliderInit() {
	...
	var cta_slider = new Swiper('.cta_slider', swiperOptions);
	var pageSections = document.querySelectorAll('.cta_img');
...
function megamenudropdown() {
	...
	const menuwrapper = document.querySelectorAll('.mega-menu-wrapper');
	...
	childLinks.forEach((childLink) => {
		childLink.addEventListener('click', () => {
			if (childLink.classList.contains('nav-third-level-open')) {
				childLink.classList.remove('nav-third-level-open');
			} else {
				childLinks.forEach((link) => link.classList.remove('nav-third-level-open'));
				childLink.classList.add('nav-third-level-open');
			}
		});
	});

	closemegamenu.addEventListener('click', () => {
		dropdowns.forEach((dropdown) => dropdown.classList.remove('menu-open'));
		document.body.classList.remove('modal-menu');
	});
}
